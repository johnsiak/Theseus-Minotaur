...
2. **Choose game mode**: Manual Play or Automated Play
3. **Select AI types** for both Theseus and Minotaur using dropdown menus
4. **Click info buttons** (i) to learn about different AI strategies
5. **Generate Board** to create a new random labyrinth
