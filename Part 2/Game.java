public class Game {
	...
	public static void main(String[] args) {
		...
		HeuristicPlayer player1 = new HeuristicPlayer(1, "Theseus", board, 0, 0, 0);	
		...
		int[] move2 = player2.move(board.getN() * board.getN()/2, 0, true);		//the first move of Minotaur. move2 stores what the array move() function returns
		n++;
		...
		while (n < 100) {
            ...
            //Minotaur plays
            move2 = player2.move(move2[0], 0, true);
